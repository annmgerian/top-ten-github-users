...
function rootReducer() {
  ...
  if (action.type === _constants_action_types__WEBPACK_IMPORTED_MODULE_1__["ADD_DATA"]) {
    return _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_0___default()({}, state, {
      data: [{
        avatarUrl: action.payload[0],
        bio: action.payload[1],
        email: action.payload[2],
        location: action.payload[3],
        login: action.payload[4],
        name: action.payload[5],
...
//# sourceMappingURL=index.js.665d885e7336635b71dc.hot-update.js.map